...
class FileServiceImplTest {
    ...
    private static final byte[] TOO_BIG_FILE_SIZE_IN_BYTES = new byte[(int) (FileServiceImpl.MAX_FILE_SIZE_IN_BYTES + 1L)];
    private static final byte[] TOO_SMALL_FILE_SIZE_IN_BYTES = new byte[(int) (FileServiceImpl.MIN_FILE_SIZE_IN_BYTES - 1L)];
    private static final byte[] VALID_MIN_FILE_SIZE_IN_BYTES = new byte[(int) (FileServiceImpl.MIN_FILE_SIZE_IN_BYTES)];
    private static final byte[] VALID_MAX_FILE_SIZE_IN_BYTES = new byte[(int) (FileServiceImpl.MAX_FILE_SIZE_IN_BYTES)];
    ...
    void shouldExceptionWhenUnsupportedMimeType() {
        ...
        final Throwable throwable = catchThrowable(() -> fileService.generateFrom(mockMultipartFile));
    ...
    void shouldGenerateValidStorageKeyWhenMimeTypeJpeg() {
        ...
        final String storageKey = fileService.generateFrom(mockMultipartFile);

        assertThat(storageKey).endsWith(FileServiceImpl.JPEG);
    }
    ...
    void shouldGenerateValidStorageKeyWhenMimeTypePng() {
        ...
        assertThat(storageKey).endsWith(FileServiceImpl.PNG);
    }
    ...
    void shouldGenerateValidStorageKeyWhenMimeTypeGif() {
        ...
        assertThat(storageKey).endsWith(FileServiceImpl.GIF);
    }
}